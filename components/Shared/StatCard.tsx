...
export default function StatCard({icon, title, value, subText, subTextGrowth, normalBg, gradientClass}: StatCardProps) {
    return(
        <div className="flex items-center gap-4 bg-surface rounded-xl p-6 shadow">
            ...
            <div>
                ...
                <p>{subTextGrowth ? <span className="text-primary"><FontAwesomeIcon icon={faArrowUp}/>{subTextGrowth}</span> : ''} {subText}</p>
            </div>
        </div>
    )
}